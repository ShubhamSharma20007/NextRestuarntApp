  ...
  // })
    ...
    const [inputValue,setInputValue]=useState({
      ...
      const handleSubmit = async(e)=>{
        e.preventDefault();
        try {
          const response =  await instance.post('/register',inputValue)
          ...
          <div className=" grid md:grid-cols-2 bg-zinc-700 items-center gap-4 max-w-6xl w-full p-4 m-4  rounded-md">
            <div className="md:max-w-md w-full sm:px-6 py-4 ">
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <input
                      ...
                      className=" rounded-md w-full bg-zinc-600   text-sm  focus:border-[#333] px-2 py-3 outline-none"
                ...
                <div className="mt-4">
                  <label className="text-xs block mb-2">Address</label>
                  <div className="relative flex items-center">
                    <input
                      name="location"
                      type="text"
